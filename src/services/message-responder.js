...
const ganyu_finder_1 = require("./ganyu-finder");
const inversify_1 = require("inversify");
const types_1 = require("../types");
let MessageResponder = class MessageResponder {
    constructor(ganyuFinder) {
...
MessageResponder = __decorate([
    ...
    __param(0, inversify_1.inject(types_1.TYPES.GanyuFinder)),
    __metadata("design:paramtypes", [ganyu_finder_1.GanyuFinder])
], MessageResponder);
